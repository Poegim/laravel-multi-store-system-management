        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 py-2">
            <div>
                <a href="#" class="store-dashboard-link">
                    ...
                    <p class="mx-auto uppercase roboto text-lg">
                        {{ __('Sell') }}
                    </p>
                </a>
            </div>
