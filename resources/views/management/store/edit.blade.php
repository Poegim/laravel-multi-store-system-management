                        ...
                        <form action="{{ route('store.update', $store) }}" method="POST">
                            ...
                            <div x-data="{ open: true}"
                                ...
                                <div class="p-4" x-show="open">
                                    ...
                                    value="{{$color->id}}" @if($store->color->id == $color->id) selected @endif>{{ $color->name }}</option>
                                    @endforeach
                                    </select>
                            ...
                            <div x-data="{ open: false}"
                                ...
                                <div class="p-4" x-show="open">
                                    ...
                                    <input type="text" id="building_number" name="building_number"
                                        class=" mb-4 border border-indigo-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                                        required value="{{old('building_number') ? old('building_number') : $store->building_number}}" />
                                    ...
                                    <input type="text" id="apartment_number" name="apartment_number"
                                        class=" mb-4 border border-indigo-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                                        required value="{{old('apartment_number') ? old('apartment_number') : $store->apartment_number}}" />
                                </div>
                            </div>
                            ...
                            <div x-data="{ open: false}"
                                ...
                                <div class="p-4" x-show="open">
                                    ...
                                    <input type="text" id="contracts_prefix" name="contracts_prefix"
                                        class=" mb-4 border border-indigo-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                                        required value="{{old('contracts_prefix') ? old('contracts_prefix') : $store->contracts_prefix}}" />
                                    ...
                                    <input type="text" id="invoices_prefix" name="invoices_prefix"
                                        class=" mb-4 border border-indigo-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                                        required value="{{old('invoices_prefix') ? old('invoices_prefix') : $store->invoices_prefix}}" />
                                    ...
                                    <input type="text" id="margin_invoices_prefix" name="margin_invoices_prefix"
                                        class=" mb-4 border border-indigo-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                                        required value="{{old('margin_invoices_prefix') ? old('margin_invoices_prefix') : $store->margin_invoices_prefix}}" />
                                    ...
                                    <input type="text" id="proforma_invoices_prefix" name="proforma_invoices_prefix"
                                        class=" mb-4 border border-indigo-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                                        required value="{{old('proforma_invoices_prefix') ? old('proforma_invoices_prefix') : $store->proforma_invoices_prefix}}" />
                                    ...
                                    <input type="text" id="internal_servicing_prefix" name="internal_servicing_prefix"
                                        class=" mb-4 border border-indigo-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                                        required value="{{old('internal_servicing_prefix') ? old('internal_servicing_prefix') : $store->internal_servicing_prefix}}" />
                                    ...
                                    <input type="text" id="external_servicing_prefix" name="external_servicing_prefix"
                                        class=" mb-4 border border-indigo-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                                        required value="{{old('external_servicing_prefix') ? old('external_servicing_prefix') : $store->external_servicing_prefix}}" />
                                </div>
                            </div>
                            ...
                            <div x-data="{ open: false}"
                                ...
                                <div class="p-4" x-show="open">
                                    ...
                                    <input type="number" id="next_receipt_number" name="next_receipt_number"
                                        class=" mb-4 border border-indigo-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                                        required value="{{old('next_receipt_number') ? old('next_receipt_number') : $store->next_receipt_number}}" />
                                    ...
                                    <input type="number" id="next_invoice_number" name="next_invoice_number"
                                        class=" mb-4 border border-indigo-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                                        required value="{{old('next_invoice_number') ? old('next_invoice_number') : $store->next_invoice_number}}" />
                                    ...
                                    <input type="number" id="next_margin_invoice_number" name="next_margin_invoice_number"
                                        class=" mb-4 border border-indigo-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                                        required value="{{old('next_margin_invoice_number') ? old('next_margin_invoice_number') : $store->next_margin_invoice_number}}" />
                                    ...
                                    <input type="number" id="next_proforma_invoice_number" name="next_proforma_invoice_number"
                                        class=" mb-4 border border-indigo-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                                        required value="{{old('next_proforma_invoice_number') ? old('next_proforma_invoice_number') : $store->next_proforma_invoice_number}}" />
                                    ...
                                    <input type="number" id="next_internal_servicing_number" name="next_internal_servicing_number"
                                        class=" mb-4 border border-indigo-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                                        required value="{{old('next_internal_servicing_number') ? old('next_internal_servicing_number') : $store->next_internal_servicing_number}}" />
                                    ...
                                    <input type="number" id="next_external_servicing_number" name="next_external_servicing_number"
                                        class=" mb-4 border border-indigo-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                                        required value="{{old('next_external_servicing_number') ? old('next_external_servicing_number') : $store->next_external_servicing_number}}" />
                                </div>
                            </div>
