            ...
            <table class="w-full text-left rtl:text-right text-gray-500 dark:text-gray-400">
                <thead class="text-sm uppercase">
                    <tr class="text-black dark:text-white">
                        <th scope="col" class="px-1 sm:px-2 sm:py-3">
                        ...
                        <th scope="col" class="px-1 sm:px-2 sm:py-3 hidden lg:table-cell">
                        ...
                        <th scope="col" class="px-1 sm:px-2 sm:py-3 text-right">
                ...
                <tbody>
                    ...
                    <tr class="bg-white dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 text-sm"
                        wire:key="row-{{ $product->id }}">
                        <td class="px-1 sm:px-2 dark:text-gray-100 font-thin">
                            {{$product->id}}
                        </td>

                        <td scope="row" class="px-1 sm:px-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            <div class="flex">
                                <a href="{{ route('product.show', [$product->brand, $product]) }}" class="link my-auto text-sm" alt="{{$product->name}}"
                        ...
                        <td scope="row" class="px-1 sm:px-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            <div class="flex">
                                <a href="{{ route('brand.show', $product->brand->slug)}}" class="link my-auto text-sm" alt="{{$product->brand->name}}"
                                    label="{{$product->brand->name}}">{{Illuminate\Support\Str::limit($product->brand->name, 30, '...')}}</a>
                            </div>
                        </td>

                        <td class="px-1 sm:px-2 hidden lg:table-cell">
                        ...
                        <td class="px-1 sm:px-2 flex justify-end">
