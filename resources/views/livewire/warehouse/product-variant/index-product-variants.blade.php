...
<x-window>
    <div class="overflow-x-auto">
        <table class="rounded overflow-hidden min-w-full text-xs text-left text-gray-700 dark:text-gray-300 border dark:border-gray-700">
            <thead class="uppercase bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300">
                    <tr class="text-black dark:text-white">
                        ...
                        <th scope="col" class="px-4 py-2  hidden xl:table-cell">
                            {{__('product id')}}
                            </th>
                        <th scope="col" class="px-4 py-2  hidden xl:table-cell">
                        {{__('ean')}}
                ...
                <tbody>
                    ...
                    <tr class="bg-white dark:bg-gray-800 border-t hover:bg-gray-100 dark:hover:bg-gray-700 transition">                        <td scope="row"
        ...
        <div class=" m-4">
            {{ $productVariants->links(data: ['scrollTo' => false]) }}
        </div>
    </x-window>
</div>
