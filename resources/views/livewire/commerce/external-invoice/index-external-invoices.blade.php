            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                <thead class="text-xs uppercase">
                    <tr class="text-black dark:text-white">
                        <th scope="col" class="px-2 py-1 lg:px-4 sm:py-3">
                        ...
                        <th scope="col" class="px-2 py-1 lg:px-4 sm:py-3 hidden lg:table-cell">
                                <span class="uppercase">
                                    {{__('contact')}}
                                </span>
                        </th>
                        ...
                        <th scope="col" class="px-2 py-1 lg:px-4 sm:py-3 hidden xl:table-cell">
                        ...
                        <th scope="col" class="px-2 py-1 lg:px-4 sm:py-3 text-right">
                ...
                <tbody>
                    ...
                    <tr class="bg-white dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700"
                        ...
                        <td class="px-2 lg:px-4 py-1 dark:text-gray-100 font-thin">
                            {{$invoice->id}}
                        </td>

                        <td scope="row" class="px-2 lg:px-4 py-1 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            <div class="flex">
                        ...
                        <td scope="row" class="font-medium px-2 lg:px-4 py-1 italic text-gray-900 whitespace-nowrap dark:text-white">
                            @if($invoice->isTemp())
                        ...
                        <td scope="row" class="px-2 lg:px-4 py-1 font-medium text-gray-900 whitespace-nowrap dark:text-white hidden lg:table-cell">
                            <div class="flex">
                        ...
                        <td class="px-2 lg:px-4 py-1 hidden xl:table-cell">
                            <div class="flex">
                        ...
                        <td class="px-2 lg:px-4 py-1 flex justify-end">
                            @if($invoice->isTemp())
