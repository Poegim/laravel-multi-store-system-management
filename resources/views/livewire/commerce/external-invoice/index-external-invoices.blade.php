            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                <thead class="text-xs uppercase">
                    <tr class="text-black dark:text-white">
                        ...
                        <th scope="col" class="px-2 py-1 sm:px-6 sm:py-3 hidden xl:table-cell">
                ...
                <tbody>
                    ...
                    <tr class="bg-white dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700"
                        ...
                        <td scope="row" class="font-medium px-2 sm:px-6 py-1 italic text-gray-900 whitespace-nowrap dark:text-white">
                            @if($invoice->isTemp())
                        ...
                        <td scope="row" class="px-2 sm:px-6 py-1 font-medium text-gray-900 whitespace-nowrap dark:text-white hidden lg:table-cell">
                            <div class="flex">
