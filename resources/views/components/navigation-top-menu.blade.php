                        ...
                        <x-slot name="trigger">
                            ...
                            @else
                                <span class="inline-flex rounded">
                                    <button type="button" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none focus:bg-gray-100 dark:focus:bg-gray-700 active:bg-gray-100 dark:active:bg-gray-700 transition ease-in-out duration-150">
                                        {{ Auth::user()->name }}
