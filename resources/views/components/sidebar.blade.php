            ...
            <ul class="space-y-2">
                ...
                <li>
                    <a href="#"
                       ...
                       <svg viewBox="0 0 48 48" fill="currentColor" class="size-6" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <rect x="4" y="24" width="20" height="22" rx="2" transform="rotate(-45 4 24)" stroke="#000000" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"></rect> <rect x="16" y="24" width="20" height="20" rx="2" transform="rotate(-45 16 24)" stroke="#000000" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"></rect> </g></svg>                       <span class="ml-3 font-medium">Warehouse</span>
                    </a>
                </li>
