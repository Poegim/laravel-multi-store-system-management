        ...
        <div
            ...
            <ul class="space-y-2">
                ...
                <li>
                    ...
                    class="flex items-center p-2 font-semibold  rounded-mid group hover:bg-gray-100 dark:hover:bg-gray-700 {{ Route::is('sale.create') ? 'nav-active-tab' : 'nav-inactive-tab'}}">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
