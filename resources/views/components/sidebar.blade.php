        ...
        <div
            ...
            <ul class="space-y-2">
                <li>
                    <a href="{{ route('dashboard') }}"
                       ...
                       class="flex items-center p-2 rounded-mid group {{ request()->routeIs('dashboard') ? 'nav-active-tab' : 'nav-inactive-tab'}}">
                        ...
                        <span class="ml-3 font-thin sm:text-lg">Dashboard</span>
                    </a>
                </li>
                ...
                <li>
                    <button type="button" @click="setLastClicked('stores')"
                        ...
                        <span class="flex-1 ml-3 text-left whitespace-nowrap font-thin sm:text-lg">Stores</span>
                        ...
                        @foreach ($stores as $store)
                            <li>
                                <a href="{{ route('store.show', $store->id) }}" wire:navigate
                                    ...
                                    <span class="ml-11 font-thin sm:text-lg">
                                        {{ $store->name}}
                                    </span>
                                </a>
                            </li>
                ...
                <li>
                    <button type="button" @click="setLastClicked('repository')"
                        ...
                        <span class="flex-1 ml-3 text-left whitespace-nowrap font-thin sm:text-lg">Repository</span>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
                            <path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
                        </svg>
                    </button>
                    ...
                    <ul class="mt-2 overflow-hidden space-y-2 border border-gray-300 dark:border-gray-700 rounded-mid "
                        ...
                        <li>
                            <a href="{{ route('category.index') }}" wire:navigate
                                ...
                                <span class="ml-2 font-thin sm:text-lg">Categories</span>
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="{{ route('brand.index') }}" wire:navigate
                                ...
                                <span class="ml-2 font-thin sm:text-lg">Brands</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('product.index') }}" wire:navigate
                                ...
                                <span class="ml-2 font-thin sm:text-lg">Products</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('product-variant.index') }}" wire:navigate
                                ...
                                <span class="ml-2 font-thin sm:text-lg">Variants</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{route('feature.index')}}" wire:navigate
                                ...
                                <span class="ml-2 font-thin sm:text-lg">Features</span>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="#"
                       ...
                       wire:navigate
                       class="flex items-center p-2 rounded-mid group {{ request()->routeIs('warehouse.test.index') ? 'nav-active-tab' : 'nav-inactive-tab'}}">
                       ...
                       <span class="ml-3 font-thin sm:text-lg">Warehouse</span>
                    </a>
                    </a>
                </li>
                ...
                <li>
                    <a href="{{ route('contact.index') }}"
                       ...
                       wire:navigate
                       class="flex items-center p-2 rounded-mid group {{ request()->routeIs('contact.index') ? 'nav-active-tab' : 'nav-inactive-tab'}}">
                        ...
                        <span class="ml-3 font-thin sm:text-lg">Contacts</span>
                    </a>
                </li>
                ...
                <li>
                    <button type="button" @click="setLastClicked('management')"
                        ...
                        <span class="flex-1 ml-3 text-left whitespace-nowrap font-thin sm:text-lg">Management</span>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
                            <path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
                        </svg>
                    </button>
                    ...
                    <ul class=" mt-2 overflow-hidden space-y-2 border border-gray-300 dark:border-gray-700 rounded-mid "
                        ...
                        <li>
                            <a href="{{ route('user.index') }}" wire:navigate
                                ...
                                <span class="ml-2 font-thin sm:text-lg">Users</span>
                            </a>
                        </li>
                        @endcan
                        ...
                        <li>
                            <a href="{{ route('store.index') }}" wire:navigate
                                ...
                                <span class="ml-2 font-thin sm:text-lg">Stores</span>
                            </a>
                        </li>
                ...
                <li>
                    ...
                    <svg
                        ...
                        <span class="ml-3 font-thin sm:text-lg">{{ __('Sell in:') }} {{ request()->route('store')->invoices_prefix }}</span>
                    </a>
                </li>
                @endif
                ...
                <li>
                    <form method="POST" action="{{ route('logout') }}" x-data>
                        ...
                        <a href="{{ route('logout') }}" @click.prevent="$root.submit();"
                            ...
                            <span class="ml-4 font-thin sm:text-lg">
                                {{ __('Log Out') }}
                            </span>
                        </a>
                    </form>
            ...
            <div class="justify-center p-4 space-x-2 w-full flex bg-white dark:bg-gray-800 z-20">
                ...
                <div id="tooltip-mode" role="tooltip"
                    class="inline-block absolute invisible z-10 py-2 px-3 text-sm font-thin sm:text-lg text-white bg-gray-900 rounded-mid  shadow-sm opacity-0 transition-opacity duration-300 tooltip">
                    Dark/Light mode
